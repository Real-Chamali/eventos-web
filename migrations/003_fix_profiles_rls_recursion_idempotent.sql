-- ============================================================================
-- Migración 003: Corregir recursión infinita en políticas RLS de profiles
...
-- ============================================================================
-- Eliminar TODAS las políticas existentes de profiles (idempotente)
-- ============================================================================
...
-- Eliminar políticas simples si existen (para recrearlas limpiamente)
...
-- Eliminar políticas de middleware si existen
...
DROP POLICY IF EXISTS "profiles_update_own_middleware" ON public.profiles;
...
-- ============================================================================
-- Verificación (opcional - comentar si no quieres ejecutar)
-- ============================================================================
...
BEGIN
  ...
  AND policyname LIKE 'profiles_%_simple';
  
  IF policy_count = 4 THEN
    RAISE NOTICE '✅ Migración 003 aplicada correctamente: % políticas simples creadas', policy_count;
  ELSE
    RAISE WARNING '⚠️  Se esperaban 4 políticas, pero se encontraron %', policy_count;
  END IF;
END $$;
