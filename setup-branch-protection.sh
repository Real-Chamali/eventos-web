...
echo "🔒 CONFIGURACIÓN DE BRANCH PROTECTION RULES"
echo "============================================"
echo ""

echo "📋 PASO 1: Configurar Branch Protection para 'main'"
echo "---------------------------------------------------"
echo ""
echo "1. Abre este enlace en tu navegador:"
echo "   https://github.com/Victhorrr/eventos-web/settings/branches"
echo ""
...
echo "📋 PASO 2: Configurar Branch Protection para 'develop'"
echo "------------------------------------------------------"
echo ""
echo "1. En la misma página, haz clic en 'Add rule' otra vez"
echo ""
...
echo ""
echo "   ⚠️  Allow force pushes: Solo para admins"
echo ""
echo "   ❌ Allow deletions: NO"
echo ""
